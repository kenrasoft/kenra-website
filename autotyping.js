    ...
    t.default = class {
      constructor(
        ...
        t,
        {
          typeSpeed: r = 150,
          deleteSpeed: n = 150,
          waitBeforeDelete: i = 1e2,
          waitBetweenWords: o = 1e2,
          writeWhole: l = !1,
        } = {}
      ) {
        (this.selector = e),
...
const exampleText = ['with Agile Software Engineering',
  'by Integrating Technology with Excellence',
  'through Innovative Technology Solutions',
  'leveraging Data & AI/ML Services',
  'via Cloud Modernization',
  'leveraging CI/CD Automation',
  'streamlining Software Development',
  'applying Agile DevOps Methodologies',
  'implementing Scalable Architectures',
  'via Robust API Implementations ',
